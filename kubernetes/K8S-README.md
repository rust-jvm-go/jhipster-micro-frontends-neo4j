...
```
$ docker image tag gateway chessequality/gateway
$ docker push chessequality/gateway
$ docker image tag blog chessequality/blog
$ docker push chessequality/blog
$ docker image tag store chessequality/store
$ docker push chessequality/store
```
